                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tbl_search">
                            <tbody>
                                <tr>
                                    ...
                                    <td width="90%">
                                        <input class="string_zen_kana clear_text text" @change="serchdata()" v-model="serchform.brand_code" :key="index" id="brand_code" maxlength="8"  name="brand_code" size="50" type="text" tabindex="10000"/>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td width="90%">
                                        <input class="string_zen_kana clear_text text" @change="serchdata()" v-model="serchform.brand_name_2" id="brand_name_2"  maxlength="50" name="brand_name_2" size="50" type="text" tabindex="10001"/>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td width="90%">
                                        <div class="selector" id="inactivced"><span>{{serchform.inactived}}</span>
                                            <select id="inactivced" name="inactivced" @change="serchdata()" v-model="serchform.inactived" tabindex="10003" style="min-width: 51px; opacity: 0; width: 80px;">
...
export default {
    ...
    methods: {
        getBrands(page=1) {
              ...
              axios.get('/api/v1/brands').then(({data})=>{
