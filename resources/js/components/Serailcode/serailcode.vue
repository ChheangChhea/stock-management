        ...
        <ol id="topicPath">
          <ol id="topicPath">
            ...
            <li>
              <span
                ><font style="vertical-align: inherit"
                  ><font style="vertical-align: inherit"> SerailCode </font></font
                ></span
              >
            </li>
          </ol>
                ...
                <tbody>
                  <tr v-for="(Serail, index) in serails.data" :key="index">
                    ...
                    <td width="12%">
                      <div class="button" id="uniform-undefined">
                        <span
                          ><i class="fa fa-edit"></i> Edit SerailCode<input
                            type="button"
...
export default {
  ...
  methods: {
    ...
    btnUpdate() {
      axios
        .post("api/v1/serail/update/" + this.form.serail_code, this.form)
        .then(() => {
          this.getSerail();
          this.form = {};
        });
