        ...
        <div class="search-box mb-4">
          ...
          <div class="search-box-title">
            ...
            <ul class="dropdown-menu">
              ...
              <li>
                <a class="dropdown-item" href="#"> Add Code</a>
              </li>
            </ul>
                ...
                <div class="ui-widget-header">
                  <h5 class="modal-title" id="staticBackdropLabel">
                    <span
                      ...
                      id="ui-dialog-title-modal-edit-dialog"
                      >{{ this.title }}</span
                    >
                  </h5>
                  <a
                ...
                <tr>
                  ...
                  <td width="50%">
                    ...
                    >
                      <option value="">Selete Suppliyer</option>
                      <option
                        v-for="graoup in graoups"
                        :value="graoup.group_code"
                      >
                        {{ graoup.group_name }}
                      </option>
                    </select>
                ...
                <tr>
                  ...
                  <td width="50%">
                    ...
                    >
                      <option value="">Selete Suppliyer</option>
                      <option
                        v-for="categor in category"
                        :value="categor.cat_code"
                      >
                        {{ categor.cat_name }}
                      </option>
                    </select>
          ...
          <div
            ...
            class="col-md-4 search-box02 flo02 outline-input-img"
            id="flo02"
          >
            <div class="box-img02">
              <img
              ...
              />
              <p class="text-upload">
                Drop an image or <br /><span style="text-decoration: underline"
                  >Upload file</span
                >
              </p>
              <input
            ...
            >
              <thead>
                ...
                <tr v-for="form_line in form_lines">
                  <th
                    class="bg_img"
                    style="justify-content: center; background-color: white"
                  >
                    <img
                  ...
                  <th>
                    <input
                      :disabled="true"
                      v-model="form_line.product_no"
                      @change="autoUpdate(form_line)"
                  ...
                  <th>
                    <div class="dropdown">
                      <button
                        @click="getunit(form_line.product_no)"
                      ...
                      >
                        ...
                        <ul style="list-style: none" class="scrollable-menu">
                          <li
                            v-for="boompro in boomunits"
                            @click="getproduct(boompro, form_line, 'linkunit')"
                          >
                            <div class="menu-item">
                  ...
                  <th>
                    <input
                      v-model="form_line.curency_code"
                      @change="autoUpdate(form_line)"
                      class="string_zen clear_text text"
                      size="50"
                      type="text"
              ...
              <vue-countdown
                ...
                @end="onCountdownEnd"
                v-slot="{ totalSeconds }"
                >Fetch again {{ totalSeconds }} seconds later</vue-countdown
              >
            </table>
          </div>
        ...
        <div class="ui-dialog-content" id="invoiceholder">
          ...
          <div id="invoice" class="effect2 card-body">
            <div id="invoice-top" style="display: none">
              <div class="logo">
                <img
                  src="https://www.almonature.com/wp-content/uploads/2018/01/logo_footer_v2.png"
                  alt="Logo"
                />
              </div>
              <div class="title">
              ...
              <div class="clearfix">
                <div class="col-md-12">
                  <div class="text-center">
                    <h3
                      class="title-purchase"
                      style="color: #84b0ca !important"
                    >
                      PRODUCT DETAILS
                    </h3>
                  </div>
                ...
                <div class="row" style="flex-wrap: inherit">
                  <div class="col-xl-6 supplier-padding">
                    <div style="display: flex">
                      <div class="clientlogo">
                        <img src="pichture/para.png" alt="Sup" />
                      </div>
                      <div>
                        <p class="text-muted title-pur-sup">
                          {{ form.description }}
                        </p>
                        <ul class="list-unstyled">
                          ...
                          <li class="text-muted">
                            Purche Unite:
                            <span style="color: #5d9fc5">{{
                              form.purche_unit_of_measure_code
                            }}</span>
                          </li>
                          <li class="text-muted">
                            Reorder:
                          ...
                          <li class="text-muted">
                            ...
                            <span style="color: #5d9fc5"
                              >{{ form.unit_price }}$ /
                              {{ form.stock_unit_of_measure_code }}</span
                            >
                          </li>
                        </ul>
                      </div>
                  ...
                  <div
                    class="col-xl-6 supplier-padding"
                    style="padding-left: 90px"
                  >
                    <p class="text-muted title-pur-sup">
                      Supplier Name: {{ getsuppliyerviews.sup_name }}
                    </p>
                    <ul class="list-unstyled">
                      <li class="text-muted">
                        Email:
                        <span style="color: #5d9fc5">{{
                          getsuppliyerviews.email
                        }}</span>
                      </li>
                      <li class="text-muted">
                        Phone No:
                        <span style="color: #5d9fc5"
                          >{{ getsuppliyerviews.phone_no }} /
                          {{ getsuppliyerviews.phone_no_2 }}</span
                        >
                      </li>
                      <li class="text-muted">
                        Company Address:
                        <span style="color: #5d9fc5">{{
                          getsuppliyerviews.address
                        }}</span>
                      </li>
                      <li class="text-muted">
                        Fax:
                        <span style="color: #5d9fc5">{{
                          getsuppliyerviews.fax_no
                        }}</span>
                      </li>
                      ...
                      <li class="text-muted">
                        Contact Name:
                        <span style="color: #5d9fc5">{{
                          getsuppliyerviews.contact_name
                        }}</span>
                      </li>
                      <li class="text-muted">
                        Contact Phone:
                        <span style="color: #5d9fc5">{{
                          getsuppliyerviews.contact_phone
                        }}</span>
                      </li>
                      <li class="text-muted">
                        Note:
                        <span style="color: #5d9fc5">{{
                          getsuppliyerviews.status
                        }}</span>
                      </li>
                    </ul>
                  </div>
            ...
            <div id="invoice-bot">
              <div id="table">
                <table class="table-main">
                  ...
                  <tbody>
                    <tr
                      v-for="(form_line, index) in form_lines"
                      :key="index"
                      id="pro-tr"
                    >
                      <td
