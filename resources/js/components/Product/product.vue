<template >
      ...
      <div id="product">
        ...
        <div class="search-box mb-4">
          ...
          <ul  class="dropdown-menu" >
                <li >
                    <a @click="getproductboom()" class="dropdown-item btn btn-primary" data-bs-toggle="modal"  data-bs-target="#staticBackdropss"  tabindex="10028">Boom Product</a>
                </li>
            </ul>
        <div class="search-box-title" style="height: 36px;">
            ...
            <ul  class="dropdown-menu" >
              <li >
                <a  @click="getMessage('Message Confirm','Do you want to create new product.','crate',code)" class="dropdown-item btn btn-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Default Code</a>
              </li>
              <li>
                <a :value="C_code" class="dropdown-item" href="#"> Add Code</a>
              </li>
            </ul>
            <router-link to="viewproduct"><a class="btn-radius btn btn-sm" href="#" style=" color: #f8f5b4;margin-top: -2px;">
              ...
              <div class="modal-dialog">
                <div class="modal-content ui-dialog">
                  <div class="ui-widget-header">
                    <h5 class="modal-title" id="staticBackdropLabel"><span class="ui-dialog-title" id="ui-dialog-title-modal-edit-dialog">{{this.title}}</span></h5>
                    <a href="#" class="ui-dialog-titlebar-close ui-corner-all" role="button"  data-bs-dismiss="modal"><span class="ui-icon ui-icon-closethick">close</span></a>
                  </div>
                  ...
                  <div class="modal-footer">
                    ...
                    <div class="button type2"   @click="messagegetconfirm(this.confirm)" :value="G_code" data-bs-dismiss="modal"><span>Yes</span></div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tbl_search">
              <tbody>
                <tr >
                  <th width="10%"> No</th>
                  <td width="50%">
                    <input :disabled="true"   @change="autoUpdateProduct(form)"  v-model="form.product_no" class="string_zen_kana clear_text text input_text" maxlength="50" size="50"
                      type="text">
                ...
                <tr>
                  ...
                  <td width="50%">
                    <input :disabled="isDisabled"  @change="autoUpdateProduct(form)"  v-model="form.product_barcode" class="string_zen_kana clear_text text input_text" maxlength="50" size="50"
                      type="text">
                  </td>
                ...
                <tr>
                  ...
                  <td width="50%">
                    <input :disabled="isDisabled" @change="autoUpdateProduct(form)"  :v-model="form.description_2" class="string_zen clear_text text input_text" size="50" type="text">
                ...
                <tr>
                  ...
                  <td width="50%">
                    <select :disabled="isDisabled"  @change="autoUpdateProduct(form)"  v-model="form.stock_unit_of_measure_code" class="form" style="width:362px;">
                ...
                <tr>
                  ...
                  <td width="50%">
                    <select :disabled="isDisabled" @change="autoUpdateProduct(form)" v-model="form.purche_unit_of_measure_code" class="form" style="width:362px;"> <option v-for="uint in uints" :value='uint.unit_code'>{{ uint.unit_of_measure }}</option> </select>
                  </td>
                ...
                <tr>
                  ...
                  <td width="50%">
                    <select :disabled="isDisabled"  v-model="form.sup_code" @change="autoUpdateProduct(form)" class="form" style="width:362px;">
                      <option value="">Selete Suppliyer</option>
                      <option v-for="suppliyer in suppliyers" :value='suppliyer.sup_code'>{{ suppliyer.sup_name }}</option>
                    </select>
                  </td>
                ...
                <tr>
                  ...
                  <td width="50%">
                    <input :disabled="isDisabled" @change="autoUpdateProduct(form)" v-model="form.unit_price" class="string_zen clear_text text input_text" size="50" type="text">
                  </td>
                ...
                <tr>
                  ...
                  <td width="50%">
                    <select @change="autoUpdateProduct(form)" v-model="form.inactived" :disabled="isDisabled" class="form" style="width:362px;"> <option value="No">No</option><option value="Yes">Yes</option></select>
                  </td>
                </tr>
              </tbody>
            </table>
        ...
        <thead>
          ...
          <tr v-for="form_line in form_lines">
            <th  class="bg_img" style=" justify-content: center;">
              <img class="loading" v-if="pending" alt="image"  @click="created()"/> <!-- This is a beautiful animation -->
            ...
            <th >
              <div class="dropdown" >
                    <button @click="getunit(form_line.product_no)"  @onmouseout="prooductboom(form_line)"  class="dropdown-toggle string_zen clear_text text" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false"  size="50"  style="width:80% !important;padding-left: 11px;padding-right: 19px;border: none;">                    
                      {{form_line.variant_unit_of_measure_code}}
                    </button>
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton1" style="max-height: 400px; width: 250px; scroll-behavior: smooth; padding: 5px;margin: 5px;box-shadow: 1px 1px 5px #141417;border: none;">
                       <p><input :disabled="isDisabled" v-model="txtsearch" @input="searchproduct(txtsearch)"  class="string_zen clear_text text" size="50" type="text" style="width:98% !important;border: 1px teal solid;border-radius: 1px;height: 30px;"></p>
            ...
            <th ><input :disabled="isDisabled" v-model="form_line.quantity_per_unit" @change="autoUpdate(form_line)"  class="string_zen clear_text text" size="50" type="text" style="width:80% !important;"></th>
            ...
            <th ><input :disabled="isDisabled" v-model="form_line.varaiant" @change="autoUpdate(form_line)"  class="string_zen clear_text text" size="50" type="text" style="width:80% !important;"></th>   
            <th > <select :disabled="isDisabled" @change="autoUpdate(form_line)"  class="form" style="width:80%;"> <option value="No">No</option><option value="Yes">Yes</option></select></th>
            <th class="bnt-02">
              <div class="button type2" id="uniform-undefined" data-bs-toggle="modal" data-bs-target="#staticBackdrop" @click="getMessage('Message','Do yout want to Delete this recode. ['+form_line.id+']','delelink',form_line.id)"><span><input type="button" class="type2" style="opacity: 0; width: 54px;" tabindex="10025" value="display"><i class="fa fa-trash" aria-hidden="true"></i> Delete</span></div>
            </th>
          </tr>
        </thead>
        <vue-countdown  style="display: none;" v-if="counting" :time="60000" @end="onCountdownEnd" v-slot="{ totalSeconds }">Fetch again {{ totalSeconds }} seconds later</vue-countdown>
      </table>
    </div>
    <div class="box-footer-pagination" style="text-align: left;">
    <div class="pagination" >
      <div class="pagination">  
        <a  @click="myFunction()" :value="G_code"  class="btn-radius bt-pn btn btn-sm show" href="#" data-bs-toggle="dropdown" aria-expanded="true" style="float: left; color: rgb(248, 245, 180); margin-top: -2px;"><i class="fas fa-plus" style="padding-right: 5px; margin-top: -2px;"></i> Generate Code </a>
      </div>
    </div>
    </div>
  </div>
  ...
  <div class="modal fade" id="staticBackdropss" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
          ...
          <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tbl_list tbl_stripe" id="myTable">
            <thead>
              ...
              <tr v-for="form_line in boomproducts">
                <th >
                  <div class="dropdown" >
                    <button @onmouseout="prooductboom(form_line)"  class="dropdown-toggle string_zen clear_text text" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false"  size="50"  style="width:80% !important;padding-left: 11px;padding-right: 19px;border: none;">                    
                      {{form_line.boom_product_id}}
                    </button>
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton1" style="max-height: 400px; width: 250px; scroll-behavior: smooth; padding: 5px;margin: 5px;box-shadow: 1px 1px 5px #141417;">
                       <p><input :disabled="isDisabled" v-model="txtsearch" @input="searchproduct(txtsearch)"  class="string_zen clear_text text" size="50" type="text" style="width:98% !important;border: 1px teal solid;border-radius: 1px;height: 30px;"></p>
                       <ul style="list-style:none ;" class="scrollable-menu">
                ...
                <th ><input :disabled="isDisabled" v-model="form_line.description" @change="proboomAutoSave(form_line)"  class="string_zen clear_text text" size="50" type="text" style="width:80% !important;"></th>
                <th ><input :disabled="isDisabled" v-model="form_line.quantity_per_unit" @change="proboomAutoSave(form_line)"  class="string_zen clear_text text" size="50" type="text" style="width:80% !important;"></th>
                <th ><input :disabled="isDisabled" v-model="form_line.quantity" @change="proboomAutoSave(form_line)"  class="string_zen clear_text text" size="50" type="text" style="width:80% !important;"></th>
                <th >
                  <div class="dropdown" >
                    <button  @click="getboomnit(form_line.product_no)" @onmouseout="prooductboom(form_line)" class="dropdown-toggle string_zen clear_text text" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false"  size="50"  style="width:80% !important;padding-left: 11px;padding-right: 19px;border: none;">                    
                ...
                <th > <select :disabled="isDisabled" v-model="form_line.inactived" @change="proboomAutoSave(form_line)"  class="form" style="width:80%;"> <option value="No">No</option><option value="Yes">Yes</option></select></th>
                <th class="bnt-02">
        ...
        <div class="modal-footer">
          <a  @click="boomcratenew()" :value="G_code" class="btn-radius bt-pn btn btn-sm show" href="#" data-bs-toggle="dropdown" aria-expanded="true" style="float: left; color: rgb(248, 245, 180); margin-top: -2px;"><i class="fas fa-plus" style="padding-right: 5px; margin-top: -2px;"></i>Add New</a>
