          ...
          <div class="box-footer-pagination">
            <div class="pagination">
              <span v-for="(link, index) in links" :key="index">
                <div
                  v-if="index == 0"
                  @click="getSuppliyer(this.currentPage - 1)"
                >
                  <i
                ...
                <div
                  ...
                  class="page current"
                  @click="getSuppliyer(index)"
                >
                  {{ index }}
                </div>
                <div v-else class="page" @click="getSuppliyer(index)">
                  {{ index }}
                </div>
              </span>
            </div>
