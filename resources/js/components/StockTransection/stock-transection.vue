                ...
                <div class="search-box mb-4">
                    ...
                    <div class="box">
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table table-striped br-table">
                            ...
                            <!-- <tbody>
                                    <tr v-for="(Category, index) in Categories.data" :key="Category.index" class="cate-td">
                                        ...
                                        <td width="12%" style="padding-right:0 !important; padding-left:0 !important">
                                            <div class="button" id="uniform-undefined">
                                                <span>Edit
                                                    <input type="button" @click="btnEdit(Category)" data-bs-toggle="modal" data-bs-target="#staticBackdrop" tabindex="10028"
                                                        style="opacity: 0; width: 76px;"/>
                                                </span>
                                            </div>
                                            <div class="button" id="uniform-undefined">
                                                <span>Delete
                                                    <input type="button" @click="btnDelete(Category.cat_code)" tabindex="10028"
                                                        style="opacity: 0;width: 76px;"/>
                                                </span>
                                            </div>
                                        </td>
